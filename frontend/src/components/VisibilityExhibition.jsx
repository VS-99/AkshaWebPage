...
const VisibilityExhibition = () => {
  return (
    <div className="relative w-full max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="hidden md:block absolute top-28 left-4 w-1 h-[400px] bg-blue-600 z-0" />

      {/* Horizontal line above IMC */}
      <div className="hidden md:block absolute top-[calc(7rem+400px)] left-4 w-[calc(100%-2rem)] h-1 bg-blue-600 z-0" />

      {/* Vertical line below IMC */}
      <div className="hidden md:block absolute top-[calc(7rem+400px)] right-4 w-1 h-[400px] bg-blue-600 z-0" />

      {/* Horizontal line below IMC */}  
      <div className="hidden md:block absolute top-[calc(7rem+800px)] left-4 w-[calc(100%-2rem)] h-1 bg-blue-600 z-0" />

      {/* End DOT */}
      <div className="hidden md:block absolute top-[calc(7rem+800px)] left-4 w-3 h-3 bg-blue-600 rounded-full z-10 -mt-1" />

      {/* DOCOMO Block */}
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center gap-14 mb-6 -mt-8">
        <img src={docomo1} alt="docomo1" className="w-full md:w-[45%] rounded shadow" />
        <img src={docomo2} alt="docomo2" className="w-full md:w-[45%] rounded shadow" />
      </div>
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center gap-14 mb-6 mt-6">
        <img src={imc1} alt="imc1" className="w-full md:w-[45%] rounded shadow" />
        <img src={imc2} alt="imc2" className="w-full md:w-[45%] rounded shadow" />
      </div>
