  ...
  return (
    <div className="flex flex-col items-center bg-[#fff3a6] min-h-screen py-10 px-4">
      ...
      <div className="relative w-full max-w-5xl flex justify-center items-center">
        ...
        <div className="absolute top-0 right-0 h-full flex items-center z-30">
          <div className="flex flex-col justify-center space-y-4">
            {features.map((_, index) => (
              <div
                key={index}
                onClick={() => handleClick(index)}
                className={`w-2 h-10 cursor-pointer transition-all duration-300 rounded-md ${
        ...
        <div className="relative w-full max-w-xl z-10 mt-5">
          <img
          ...
          {/* Right Aligned Text */}
          {activeIndex % 2 === 0 && (
            <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-start items-end text-white p-6 max-w-[70%] ml-auto text-right">
          ...
          {/* Left Aligned Text */}
          {activeIndex % 2 !== 0 && (
            <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-start items-start text-white p-6 max-w-[70%] mr-auto text-left">
              <h3 className="text-xl md:text-2xl font-bold mb-2">
                {features[activeIndex].title}
              </h3>
              <p className="text-sm md:text-base break-words">
      ...
      {activeIndex % 2 == 0 &&(
        <div className="relative mt-[-40px] z-20 w-full max-w-6xl">
            <div className="absolute -bottom-12 -left-20 right-0 flex justify-center">
            <img
                src={macbookImage}
                alt="Laptop"
      ...
      {activeIndex % 2 !== 0 &&(
        <div className="relative mt-[-40px] z-20 w-full max-w-6xl">
            <div className="absolute -bottom-12 left-0 -right-20 flex justify-center">
            <img
                src={macbookImage}
                alt="Laptop"
                className="w-[50%] md:w-[80%] lg:w-[50%] object-contain"
